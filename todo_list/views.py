...
def home(request):
        return render(request, 'home.html', {'user' : "kvlpaladin"})

def contact(request):
        return render(request, 'contact-us.html', {'user' : "kvlpaladin"})

def about(request):
        my_name = "Kier Venz L. Paladin"
...
def listings(request):
        if request.method == 'POST':
                ...
                if form.is_valid():
                        ...
                        context = {'all_items' : all_items, "user": "kvlpaladin"}
